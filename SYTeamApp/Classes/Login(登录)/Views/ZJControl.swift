...
@IBDesignable public class ZJControl: UIControl {
    
    // MARK: - Public Properties
    
    public var items: [String] = ["男", "女"] {
        didSet {
            setupLabels()
        }
    }
    ...
    @IBInspectable public var font: UIFont! = UIFont.systemFontOfSize(30) {
        didSet {
            setFont()
        }
    }
...
extension ZJControl: UIGestureRecognizerDelegate {
