//
//  PublicNoticeImageTableViewCell.swift
//  SYTeamApp
//
...
import UIKit
class PublicNoticeImageTableViewCell: UITableViewCell {
    var model:EMMessage?{
        didSet{
            let message = model!.body as! EMImageMessageBody
     //       DateLabel.text = "\(model!.timestamp)"
            ...
            MessageImage.image = UIImage(named: message.thumbnailLocalPath)
        }
    }
    ...
    lazy var DetailImage:UIImageView = {
        ...
        imageview.image = UIImage(named: "返回")
        return imageview
...
//        }
        ...
        let height = (contentView.frame.width - 30 - 20)/16*9
        ...
        MessageImage.snp_makeConstraints { (make) -> Void in
            ...
            make.left.right.equalTo(MessageDate)
