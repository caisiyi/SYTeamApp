...
class PublicNoticeViewController: NormalNavViewController,ConversationManagerDelegate {
...
extension PublicNoticeViewController:UITableViewDelegate,UITableViewDataSource{
...
extension PublicNoticeViewController:DZNEmptyDataSetSource,DZNEmptyDataSetDelegate {
    func imageForEmptyDataSet(scrollView: UIScrollView!) -> UIImage! {
        return UIImage(named: "投票")!
    }
    func buttonTitleForEmptyDataSet(scrollView: UIScrollView!, forState state: UIControlState) -> NSAttributedString! {
        return
            NSAttributedString(string: "暂无公告", attributes: [NSFontAttributeName:UIFont.systemFontOfSize(17)])
    }
//    
