...
class UUChatLeftMessageCell: UITableViewCell {
    ...
    internal var contentImage:UIImageView!
        ...
        didSet{
            ...
            case .Image:
                ...
                if model!.image != nil {
                    ...
                    self.contentButton.sd_setImageWithURL(NSURL(string: model!.imageUrl!), forState: UIControlState.Normal, placeholderImage: UIImage(named: "headImage"))
                }
